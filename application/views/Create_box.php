...
<div class="container">
	...
	<div class="col-md-8 col-md-offset-2" style="margin-top: 10%">
        ...
        <form id="newBinForm" method="post" action="<?php echo base_url() . 'super_admin_c/box_calculation/'.$pid.'/'.$barcode ?>">
        	<label><h3>Please Enter the Box Name:</h3></label>            
        	<input type="text" class="bin" name="box_name" autofocus="true" style="width: 100%; height: 6vh; border-radius: 5px;">
            <?php 
