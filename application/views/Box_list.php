			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        ...
			        <div class="modal-body">
			          <form id="newBoxForm" method="post" action="<?php echo base_url() . 'super_admin_c/box_calculation/'. $pid ?>">
                    ...
                    <?php
                        ...
                        <tr>
											<td><a
												href="<?php echo base_url() . 'super_admin_c/box_calculation1/' .  $pid . '/' . $c['box_id']?>"
												title="Details"><?php  echo $c['box_name']; ?></a></td>
												<td><a
												href="<?php echo base_url() . 'super_admin_c/select_box_report/'. $pid . '/' . $c['box_id'] ?>"
												title="Details"><?php echo $c['dtype']; ?></a></td>
